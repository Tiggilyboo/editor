...
pub static LETTER_OTHER : &'static [char] = &[
    ...
    '\u{1EEB7}', '\u{1EEB8}', '\u{1EEB9}', '\u{1EEBA}', '\u{1EEBB}'];
...
pub static PUNCTUATION_OTHER : &'static [char] = &[
    ...
    '\u{FF1F}', '\u{FF20}', '\u{FF3C}', '\u{FF61}', '\u{FF64}', '\u{FF65}'];
...
pub static SYMBOL_OTHER : &'static [char] = &[
    ...
    '\u{1B76}', '\u{1B77}', '\u{1B78}', '\u{1B79}', '\u{1B7A}', '\u{1B7B}', '\u{1B7C}'];
